...
- **Pre-start:**
  ![Pre-start](demo/1.png)
- **Start:**
  ![Start](demo/2.png) 
- **Profile Setup:**  
  ![Profile Setup](demo/3_1.png)
  ![Profile Setup](demo/3_2.png)
- **Water Logging:**  
  ![Water Logging](demo/4.png)
- **Food Logging:**  
  ![Food Logging](demo/5.png)
  ![Food Logging](demo/7.png)
- **Workout Logging:**  
  ![Workout Logging](demo/6.png)
- **Progress Report:**  
  ![Progress Report](demo/8.png)
